...
$(function () {
    ...
    setInterval(function () {
        if(index >= 2) {
            ...
            index = parseInt(Math.random()*10) - 5;
        }
        $('#animat span').eq(index).addClass('ani').siblings().removeClass('ani');
    }, 2000);

    var lis = $('#filters').children('li');
    $.each(lis, function (a, b) {
        $('#js, #angularjs, #ionic').hide();

        $(b).mouseenter(function () {
            $('#filters span').removeClass('active');
            $($('#filters span')[a]).addClass('active');
    ...
    $('.on').hover(function (event) {
        $(this).find('.des_html1').show();
    },function (event) {
        $(this).find('.des_html1').hide();
    })
